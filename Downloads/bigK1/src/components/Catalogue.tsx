            ...
            <div key={product.name} className={`flex flex-col lg:flex-row gap-12 ${
              ...
              <div className="lg:w-1/2 space-y-6">
                ...
                <div className="pt-4">
                  <a
                    href={product.href}
                    className="inline-flex items-center px-6 py-3 bg-[#EDAF3D] text-black rounded-full hover:bg-opacity-90 transition-all transform hover:scale-105 font-semibold"
                  >
                    More Info
                  </a>
                </div>
